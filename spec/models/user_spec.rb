...
RSpec.describe User, type: :model do
  context 'a valid user' do
    let(:valid_user) { User.create(first_name: 'Test', surname: 'Testerson', email: 'test@test.com') }
  ...
  context 'an invalid user' do
    let(:no_name) { User.create(first_name: '', surname: 'Testerson', email: 'test@test.com') }
    let(:no_surname) { User.create(first_name: 'Test', surname: '', email: 'test@test.com') }
    let(:no_email) { User.create(first_name: 'Test', surname: 'Testerson', email: '') }
